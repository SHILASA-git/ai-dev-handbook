# Workshop map — open this file

Trainer: keep this tab open. Students: jump to the page for the **current block**. Labs stay in [`ai-workshop`](../ai-workshop/).

Schedule: [ai-workshop/SCHEDULE.md](../ai-workshop/SCHEDULE.md)

---

## Day 1 — AI tools, design, full-stack
...
| Task Tracker API | [day1/04-lab-task-tracker.md](../ai-workshop/day1/04-lab-task-tracker.md) | [jobs/coding.md](jobs/coding.md) · [prompts.md](prompts.md) (Day 1 checklist) |
| Full-stack UI | [day1/05-ui-glimpse.md](../ai-workshop/day1/05-ui-glimpse.md) | [jobs/coding.md](jobs/coding.md) |
| Debug clinic | end of Day 1 | [jobs/debugging.md](jobs/debugging.md) |

**Day 1 prompts:** [prompts.md](prompts.md#day-1--task-tracker--ui)

---

## Day 2 — Automation, AppSec, OSS, ship
...
**Day 2 prompts:** [prompts.md](prompts.md#day-2--automation-appsec-mini-project)

---

## Trainer 10-second lookup

| If students are… | Point them at |
|------------------|----------------|
...
| Asking “how did we get to GPTs?” | [ai-history.md](ai-history.md) |
| Lost after the workshop | [after/README.md](after/README.md) |
